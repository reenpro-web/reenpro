  ...
  <div class="container mb-auto mt-auto">
    <div class="row justify-content-center">
      <div class="col-12 col-md-10 col-lg-8  text-center">
        <?php if (get_field('products_intro_heading', $term)) { ?>
          <h1
            class="products-intro__heading c-white h3 mb-40 mb-md-30"><?php the_field('products_intro_heading', $term); ?></h1>
        <?php } elseif (get_field('products_intro_heading', 'options')) { ?>
          <h1
            class="products-intro__heading c-white h3 mb-40 mb-md-30"><?php the_field('products_intro_heading', 'options'); ?></h1>
        <?php } ?>
        <?php if (get_field('products_intro_text', $term)) { ?>
          <div
            class="products-intro__text fs-15 fs-md-20 c-white"><?php the_field('products_intro_text', $term); ?></div>
        <?php } elseif (get_field('products_intro_text', 'options')) { ?>
          <div
            class="products-intro__text fs-15 fs-md-20 c-white"><?php the_field('products_intro_text', 'options'); ?></div>
        <?php } ?>
      </div>
    </div>
  </div>
</div>
<div class="products-list bg-purple pt-50 pt-lg-120 pb-100 pb-lg-155">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 text-center">
        <h2
          class="c-white h3 mb-50 mb-lg-80">  <?php echo get_queried_object()->name; ?></h2>
      </div>
...
<?php if (have_rows('warranty_list', $term)) { ?>
    ...
    <div class="row">
      <div class="col-12 col-lg-6 mb-50 mb-md-0 pl-0 pr-0 pr-md-6 pl-md-0">
        <div class="products-warranty__img">
          <?php echo wp_get_attachment_image(get_field('warranty_img', $term), 'full'); ?>
        </div>
      </div>
      <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
        <div class="products-warranty__wrapper pl-15 pr-15 pl-lg-0 pr-lg-20 pt-30 pt-lg-0 pb-30 pb-lg-0">
          <?php if (get_field('warranty_heading', $term)) { ?>
            <h2 class="auto-financing__heading mb-45 h3"><?php the_field('warranty_heading', $term); ?></h2>
          <?php } ?>
          <?php if (get_field('warranty_text', $term)) { ?>
            <div class="products-warranty__text mb-45">
              <?php the_field('warranty_text', $term); ?>
            </div>
          <?php } ?>
          <div class="products-warranty__list">
            <?php $i = 1; ?>
            <?php while (have_rows('warranty_list', $term)) { ?>
              <?php the_row(); ?>
              <div class="mb-30 products-warranty__list-item">
                <span class="products-warranty__list-item--number"><?php echo $i; ?></span>
                <h3 class="mb-15 fw-bold h4">
...
<?php } elseif (have_rows('warranty_list', 'options')) { ?>
  <div class="products-warranty  mb-120 mt-50 mt-lg-120">
    <div class="row">
      <div class="col-12 col-lg-6 mb-50 mb-md-0 pl-0 pr-0 pr-md-6 pl-md-0">
        <div class="products-warranty__img">
      ...
      <div class="col-12 col-lg-6 col-xl-5 offset-xl-1">
        <div class="products-warranty__wrapper pl-15 pr-15 pl-lg-0 pr-lg-20 pt-30 pt-lg-0 pb-30 pb-lg-0">
          <?php if (get_field('warranty_heading', 'options')) { ?>
            <h2 class="auto-financing__heading mb-45 h3"><?php the_field('warranty_heading', 'options'); ?></h2>
          <?php } ?>
...
<?php } ?>
<?php if (have_rows('production_list', $term)) { ?>

  <div class="products-production pt-50 pt-lg-120 pb-120 pb-lg-155">
    <div class="container">
      <div class="row  justify-content-center">
        <div class="col-12 col-lg-10 col-xl-8 text-center">
          <?php if (get_field('production_heading', $term)) { ?>
            <h2
              class="products-production__heading h3 mb-50 mb-lg-80"><?php the_field('production_heading', $term); ?></h2>
          <?php } ?>
          <?php if (get_field('production_text', 'options')) { ?>
            <div
              class="products-production__text mb-80"><?php the_field('production_text', $term); ?></div>
          <?php } ?>
        </div>
        <div class="col-12 col-xl-10  text-center">

          <div class="row custom-row products-production__wrapper">
            <?php while (have_rows('production_list', $term)) { ?>
              <?php the_row(); ?>
              <div class="col-12 col-lg-4 mb-50 mb-lg-0 text-center custom-column">
                <div class="products-production__item">
                  ...
                  <h3 class="mb-20 h4"><?php the_sub_field('heading'); ?></h3>
...
<?php } elseif (have_rows('production_list', 'options')) { ?>
            ...
            <?php while (have_rows('production_list', 'options')) { ?>
              ...
              <div class="col-12 col-lg-4 mb-50 mb-lg-0 text-center custom-column">
                <div class="products-production__item">
                  ...
                  <h3 class="h4 mb-20"><?php the_sub_field('heading'); ?></h3>
                  <div><?php the_sub_field('text'); ?></div>
                </div>
              </div>
            <?php } ?>
...
<?php 
if ( is_tax('installation_category', 'elektromobiliu-ikrovimo-stoteles') ) {
    get_template_part('includes/auto-form');
}
else if(is_tax('installation_category', 'baterijos-kaupikliai')){
...
<style>
  @media only screen and (max-width: 768px) {
    .products-intro {
    <?php if (get_field('products_intro_img_mobile', $term))  { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('products_intro_img_mobile', $term), 'full') ?>);
    <?php } elseif (get_field('products_intro_img', $term)) { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('products_intro_img', $term), 'full') ?>);
    <?php } elseif (get_field('products_intro_img_mobile', 'options')) { ?>
    ...
    .products-production {
    <?php if (get_field('production_img_mobile', $term))  { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('production_img_mobile', $term), 'full') ?>);
    <?php } elseif (get_field('production_img', $term)) { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('production_img', $term), 'full') ?>);
    <?php } elseif (get_field('production_img_mobile', 'options')) { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('production_img_mobile', 'options'), 'full') ?>);
    <?php } else { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('production_img', 'options'), 'full') ?>);
    <?php } ?>
    }
  }
  @media only screen and (min-width: 769px) {
    .products-intro {
    <?php if (get_field('products_intro_img', $term))  { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('products_intro_img', $term), 'full') ?>);
    <?php } else { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('products_intro_img', 'options'), 'full') ?>);
    <?php } ?>
    ...
    .products-production {
    <?php if (get_field('production_img', $term))  { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('production_img', $term), 'full') ?>);
    <?php } else { ?>
      background-image: url(<?php echo wp_get_attachment_image_url(get_field('production_img', 'options'), 'full') ?>);
    <?php } ?>
